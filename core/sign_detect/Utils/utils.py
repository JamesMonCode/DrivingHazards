...
def detect_object(yolo, img,  #we could replace img_path with just an img parameter and then directly pass in img from when the objecct in the wrapper file is first initialized
save_img, save_img_path="./", postfix=""):
    """
    ...
    if save_img:
        ...
        new_image.save('C:\\Users\\kylez\\DrivingHazards\\shit.png')
